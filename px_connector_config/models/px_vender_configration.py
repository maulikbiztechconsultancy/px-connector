...
class PrintingProductFieldLine(models.Model):
    _name = 'printing.product.attribute.line'
    _description = 'Printing Product Attribute Line'
    ...
    attribute_id = fields.Many2one(
        ...
        string="Attribute")
    custom_value = fields.Char(string="Custom Value")
    stop_variant_creation = fields.Boolean('Stop variant creation')
...
class CategoryFieldLine(models.Model):
    ...
    product_category_field_id = fields.Many2one(
        ...
        domain="[('model', '=', 'product.category'), ('store', '=', True)]"
    )
    custom_value = fields.Char(string="Custom Value")
